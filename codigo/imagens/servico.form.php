...
<? function campos_form($gdb){ ?>
    ...
    <tr><td>
           ...
           <tr>
            ...
            <td>
              <font class="label">Duração :</font><br/>
     ...
     <tr><td>
       <table><tr>
       <td>
          <font class="label">Descrição :</font><br/>
     ...
     <tr>
     <td>
       <font class="label">Descrição do Defeito :</font><br/>  
...
<!--     <tr><td align="center">&nbsp;</td></tr>      -->
     <tr class="sub_titulo"><td align="center">Lançamento de Peças e Serviços</td></tr>
     <tr><td>
       <table><tr>     
       ...
       <td><font class="label">Descrição :</font><br><input type="text" name="ds_produto" id="ds_produto" size="41" maxlength="40" value="" ></td>
       ...
       <td><font class="label">Quantidade :</font><br>
           <input type="text" style="text-align:right" 
				  ...
				  onblur="atualizar_valores();if (this.value == '') this.value = '0,00'; else return(currencyFormat(this,'.',',',event));" ></td>
       ...
       <td ><font class="label">Total :</font><br>
            <input type="text" style="text-align:right" 
                   ...
                   onKeyPress="return(currencyFormat(this,'.',',',event));"
				   onblur="if (this.value == '') this.value = '0,00'; else return(currencyFormat(this,'.',',',event));" >
     ...
     <tr>
        ...
        <td>
          <font class="label">Valor do Serviço :</font><br/>
          <input type="text" style="text-align:right"  
                 name="val_ser" id="val_ser" 
                 size="10" maxlength="9" 
                 onKeyPress="return(currencyFormat(this,'.',',',event));"
				 onblur="atualizar_totais(this); if (this.value == '') this.value = '0,00'; else return(currencyFormat(this,'.',',',event)); " >
        </td>
        <td>
