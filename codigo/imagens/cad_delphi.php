<!--Funções para montagem do cadastro-->
...
<? function botoes_procura($ativar){ ?>
    <table class="limpa" width="100%" height="150%">    
  <? if( $ativar == 'n'){ ?>
        <tr><td align="left" >
          <img src="../imagens/btn_novo.jpg" onclick="pesquisar(0);" width="85%" height="85%"/>
        </td></tr>
        <tr><td>&nbsp;</td></tr>      
  <? }else if( $ativar == 'p'){ ?>    
        <tr><td align="left" >  
          <img src="../imagens/btn_procurar.jpg" onclick="pesquisar(1);"  width="85%" height="85%"/>                       
        </td></tr>
        <tr><td>&nbsp;</td></tr>      
<?   } ?>      
      <tr><td align="left" >  
        <img src="../imagens/btn_sair.jpg" onclick="sair();"  width="85%" height="85%" />                                  
      </td>
	  </tr>
        <tr><td>&nbsp;</td></tr>            
    </table>
    ...
    <tr>
      <td>
        ...
        <select name="in_tipo">
           ...
           <option value=3>Endereço do Cliente</option>
           <option value=4>Telefone do Cliente</option>
         </select>          
      </td>
      <td>
        <font class="label">Contém na Busca :</font><br/>
    ...
    <tr>
      <td>
        ...
        <select name="in_tipo">
           ...
           <option value=2>Endereço do Cliente</option>
