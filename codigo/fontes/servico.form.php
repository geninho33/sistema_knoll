...
<table class="table_externa" >
  ...
  <tr  height="150%">
    <!-- Area dos bot&otilde;es de opera&ccedil;&otilde;es -->  
    <td valign="middle">
    <? botoes_operacao(); ?>
    </td>
...
<!--
  ...
  <? if($nu_serv !=''){  ?>
		...
		navegar_registro('Buscar',<? print $nu_serv; ?> ); 
  <? }else{?>
...
<? function campos_form($gdb){ ?>
    ...
    <tr><td>
           ...
           <tr>
            ...
            <td>
              ...
              <select  name="in_status" id="in_status" >
                 ...
                 <option value="Aguardando Pe&ccedil;a">Aguardando Pe&ccedil;a</option>           
      ...
      <tr>
        ...
        <td>
          <font class="label">Municip&iacute;o :</font><br/>
     ...
     <tr class="sub_titulo"><td align="center">Dados do Eletrodom&eacute;stico</td></tr>
     <tr><td>
       <table><tr>
       <td>
